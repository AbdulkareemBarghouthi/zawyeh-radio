      ...
      <div className="relative z-10">
        ...
        <main className="flex-1">
          <Routes>
            ...
            <Route path="/schedule" element={<Schedule onShowClick={handleShowClick} />} />
            <Route path="/residents" element={<Residents onResidentClick={handleResidentClick} />} />
            <Route path="/about" element={<About />} />
            <Route 
              path="/show/:showId" 
              element={<ShowDetail onBack={handleBack} onShowClick={handleShowClick} />} 
            />
            <Route 
              path="/resident/:residentId" 
              element={<ResidentDetail onBack={handleBack} onShowClick={handleShowClick} />} 
            />
          </Routes>
        </main>
        <Footer isLive={true} />
